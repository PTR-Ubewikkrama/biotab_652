...
import { handleGenerateValveCardExcel } from "./fan-excel";
...
import { FanTest, useGetFanTestQQuery, useGetFanTestsMutation } from "../../../services/fan_test_service";
...
const columns: GridColDef[] = [
  ...
  {
    field: "drawCurrent",
    headerName: "Draw Current",
    width: 150,
  },
  {
    field: "drawCurrentState",
    headerName: "Draw Current State",
    width: 200,
  },
  {
    field: "fanSpeed",
  ...
  {
    field: "fanSpeedState",
    headerName: "Fan Speed State",
    width: 200,
  },
  {
    field: "overallFanState",
    headerName: "Overall Fan State",
    width: 200,
  },
  {
    field: "Status",
...
export default function FanList() {
  ...
  const [selectedRows, setSelectedRows] = React.useState<FanTest[]>([]);

  var { data, error, isLoading } = useGetFanTestQQuery({
    data: {
  ...
  const [getAll] = useGetFanTestsMutation();

  const handleChange = (event: React.ChangeEvent<unknown>, value: number) => {
    setPage(value);
  };

  const handleRowClick = (item: FanTest) => {
