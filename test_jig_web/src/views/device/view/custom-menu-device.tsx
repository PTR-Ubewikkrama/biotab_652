...
import { Device } from "../../../services/device_service";
// import { DeviceActions } from "./DeviceActions";

type CustomMenuPropsDevice = {
    device: Device;
}
...
export default function CustomizedMenusDevices({ device }: CustomMenuPropsDevice) {
    ...
    return (
        <div>
            ...
            {/* <DeviceActions open={openCloseDetailView} changeOpenStatus={setOpenCloseDetailView} device={device} /> */}
        </div>
    );
}